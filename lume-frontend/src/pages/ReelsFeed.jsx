...
const ReelsFeed = ({ feedType = 'global' }) => {
  ...
  const isLiked = post.isLikedByMe || (Array.isArray(post.likes) && post.likes.includes(user?._id));
  const isSaved = post.isSavedByMe || (Array.isArray(post.savedBy) && post.savedBy.includes(user?._id));
